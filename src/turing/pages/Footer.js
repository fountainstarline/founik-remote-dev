            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-6 footer-links">
                ...
                <ul>
                  ...
                  <li><a href="/app-solutionkit">Book free consultation </a></li>

                </ul>
              </div>

              <div className="col-lg-4 col-md-6 footer-links">
                <h4>About Parent Company (Founik Soft)</h4>
                <ul>
        ...
        <div className="container d-md-flex justify-content-around py-4">
          ...
          <div className="mr-md-auto text-center text-md-left">
            <div className="copyright">
              &copy; Copyright 2021 <strong><span>Founik Remote</span></strong>. All Rights Reserved
            </div>
          ...
          <div className="social-links text-center text-md-left pt-3 pt-md-0">
            ...
            <a href="https://web.facebook.com/FounikRemote/" target="blank" className="facebook"><i className="bx bxl-facebook"></i></a>
            <a href="https://www.instagram.com/founikremote/" target="blank" className="instagram"><i className="bx bxl-instagram"></i></a>
            
            <a href="https://www.linkedin.com/company/founik-remote"  target="blank" className="linkedin"><i className="bx bxl-linkedin"></i></a>
          </div>
        </div>
      </footer>
