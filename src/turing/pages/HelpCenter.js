                ...
                <div className="container">
                    <div className="row">
                        <div className="
                            ...
                            <h2>
                                Need some assistant on any Tech or hiring of the right developers for your business or project-related issues? founik remote is here to assist you.

                            </h2>
                            <div></div>
                        </div>
                        <div className="col-lg-6 hero-img" data-aos="t">
                            {/* eslint-disable-next-line */}
                            <img src="assets/img/Client-Support.png" className="img-fluid animated" alt="founik soft undraw image of a receptionist"/>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <div className="col-lg-6 col-md-12 order-1 order-lg-2">
                                <form id="myForm" className="php-email-form">
                                    ...
                                    <div className="form-group">
                                        ...
                                        ref="phoneRef" className="form-control" id="Phone" placeholder="You can type in your country code directly on form field" minlength="9" maxlength="16" pattern="[0-9,+, -]+" required/>
                                    </div>
                                    <div className="form-group">
