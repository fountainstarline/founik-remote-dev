...
const Support = () => {
    ...
    document.head.querySelector('meta[name=description]').content = "Need some support on any Tech or business related issues? founik soft is here to assist you";
    document.head.querySelector('meta[name=keywords]').content = "software apps maintainance, mobile-apps maintainance, website maintainance, web-application maintainance, business digitalization, about founik soft";
    ...
    return (
        <>
            ...
            <body>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="
                                ...
                                <h2>
                                    Need some support on any hiring of developer or business related issues? founik remote is here to give you the right support you need.
                ...
                <script src="assets/vendor/intlTelInput/utils.js"></script>
